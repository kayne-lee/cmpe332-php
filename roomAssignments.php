    ...
    <body class="relative bg-gray-100 min-h-screen font-mono">
        ...
        <div class="p-40">
            <?php
                ...
                echo "<h1 class='text-2xl font-bold mb-6'>Students in Room $roomNum:</h1>";
                $query = 'SELECT firstName, lastName FROM student WHERE roomNumber="'.$roomNum.'"';
                $result = $connection->query($query);
            ?>

            <table class="w-full max-w-md border border-gray-400 bg-white rounded shadow">
                <thead>
                ...
                <tbody>
                    <?php
                        if ($result->rowCount() > 0) {
                            ...
                            echo "<tr><td colspan='2' class='p-4 text-center text-gray-500'>No students assigned to this room.</td></tr>";
                        }
